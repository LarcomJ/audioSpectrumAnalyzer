// ======================================================================
// audioSpectrumAnalyzer.v generated from TopDesign.cysch
// 12/21/2021 at 20:09
...
// VDAC8_v1_90(Data_Source=0, Initial_Value=25, Strobe_Mode=1, VDAC_Range=0, VDAC_Speed=2, Voltage=100, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMMENT=, CY_COMPONENT_NAME=VDAC8_v1_90, CY_CONFIG_TITLE=VDAC8, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=DVDAC_1:VDAC8, CY_INSTANCE_SHORT_NAME=VDAC8, CY_MAJOR_VERSION=1, CY_MINOR_VERSION=90, CY_PDL_DRIVER_NAME=, CY_PDL_DRIVER_REQ_VERSION=, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.4, INSTANCE_NAME=DVDAC_1_VDAC8, )
...
// DVDAC_v2_10(DAC_Range=0, Initial_Value=2048, InternalClock=true, InternalClockFreqHz=1000000, Resolution=12, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMMENT=, CY_COMPONENT_NAME=DVDAC_v2_10, CY_CONFIG_TITLE=DVDAC_1, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=DVDAC_1, CY_INSTANCE_SHORT_NAME=DVDAC_1, CY_MAJOR_VERSION=2, CY_MINOR_VERSION=10, CY_PDL_DRIVER_NAME=, CY_PDL_DRIVER_REQ_VERSION=, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.4, INSTANCE_NAME=DVDAC_1, )
...
module top ;
	...
	wire [0:0] tmpOE__pga_in_net;
	wire [0:0] tmpFB_0__pga_in_net;
	wire [0:0] tmpIO_0__pga_in_net;
	wire [0:0] tmpINTERRUPT_0__pga_in_net;
	electrical [0:0] tmpSIOVREF__pga_in_net;
	...
	cy_psoc3_pins_v1_10
		...
		pga_in
		 (.oe(tmpOE__pga_in_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__pga_in_net[0:0]}),
		  .analog({Net_1}),
		  .io({tmpIO_0__pga_in_net[0:0]}),
		  .siovref(tmpSIOVREF__pga_in_net),
		  .interrupt({tmpINTERRUPT_0__pga_in_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__pga_in_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__pga_out_net;
	wire [0:0] tmpFB_0__pga_out_net;
	wire [0:0] tmpIO_0__pga_out_net;
	wire [0:0] tmpINTERRUPT_0__pga_out_net;
	electrical [0:0] tmpSIOVREF__pga_out_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("63c06ae0-7926-4248-8d20-386607d7244f"),
		  ...
		  .input_buffer_sel(2'b00))
		pga_out
		 (.oe(tmpOE__pga_out_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__pga_out_net[0:0]}),
		  .analog({Net_5}),
		  .io({tmpIO_0__pga_out_net[0:0]}),
		  .siovref(tmpSIOVREF__pga_out_net),
		  .interrupt({tmpINTERRUPT_0__pga_out_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__pga_out_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__pga_ref_net;
	wire [0:0] tmpFB_0__pga_ref_net;
	wire [0:0] tmpIO_0__pga_ref_net;
	wire [0:0] tmpINTERRUPT_0__pga_ref_net;
	electrical [0:0] tmpSIOVREF__pga_ref_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("95a96c33-bc10-4a3e-99e6-6149764a3fb0"),
		  ...
		  .input_buffer_sel(2'b00))
		pga_ref
		 (.oe(tmpOE__pga_ref_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__pga_ref_net[0:0]}),
		  .analog({Net_93}),
		  .io({tmpIO_0__pga_ref_net[0:0]}),
		  .siovref(tmpSIOVREF__pga_ref_net),
		  .interrupt({tmpINTERRUPT_0__pga_ref_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__pga_ref_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	wire [0:0] tmpOE__Pin_debug1_net;
	wire [0:0] tmpFB_0__Pin_debug1_net;
	wire [0:0] tmpIO_0__Pin_debug1_net;
	wire [0:0] tmpINTERRUPT_0__Pin_debug1_net;
	electrical [0:0] tmpSIOVREF__Pin_debug1_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("e851a3b9-efb8-48be-bbb8-b303b216c393"),
		  ...
		  .input_buffer_sel(2'b00))
		Pin_debug1
		 (.oe(tmpOE__Pin_debug1_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Pin_debug1_net[0:0]}),
		  .io({tmpIO_0__Pin_debug1_net[0:0]}),
		  .siovref(tmpSIOVREF__Pin_debug1_net),
		  .interrupt({tmpINTERRUPT_0__Pin_debug1_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Pin_debug1_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__Pin_adc_eoc_net;
	wire [0:0] tmpFB_0__Pin_adc_eoc_net;
	wire [0:0] tmpIO_0__Pin_adc_eoc_net;
	wire [0:0] tmpINTERRUPT_0__Pin_adc_eoc_net;
	electrical [0:0] tmpSIOVREF__Pin_adc_eoc_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("fa2048ab-39ab-4f28-85d2-56e7ecd6702a"),
		  ...
		  .input_buffer_sel(2'b00))
		Pin_adc_eoc
		 (.oe(tmpOE__Pin_adc_eoc_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Pin_adc_eoc_net[0:0]}),
		  .io({tmpIO_0__Pin_adc_eoc_net[0:0]}),
		  .siovref(tmpSIOVREF__Pin_adc_eoc_net),
		  .interrupt({tmpINTERRUPT_0__Pin_adc_eoc_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Pin_adc_eoc_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

    DVDAC_v2_10_3 DVDAC_1 (
        .clock(1'b0),
        .Vout(Net_20));
    ...
    SPI_Master_v2_50_5 SPI_led (
        ...
        .ss(Net_40),
        .tx_interrupt(Net_46));
    defparam SPI_led.BidirectMode = 0;
    defparam SPI_led.HighSpeedMode = 0;
    defparam SPI_led.NumberOfDataBits = 8;
    defparam SPI_led.ShiftDir = 0;

	wire [0:0] tmpOE__Pin_LE_net;
	wire [0:0] tmpFB_0__Pin_LE_net;
	wire [0:0] tmpIO_0__Pin_LE_net;
	wire [0:0] tmpINTERRUPT_0__Pin_LE_net;
	electrical [0:0] tmpSIOVREF__Pin_LE_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("242e5be9-9ce1-45d3-8ea8-ab8468c810c4"),
		  ...
		  .input_buffer_sel(2'b00))
		Pin_LE
		 (.oe(tmpOE__Pin_LE_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Pin_LE_net[0:0]}),
		  .io({tmpIO_0__Pin_LE_net[0:0]}),
		  .siovref(tmpSIOVREF__Pin_LE_net),
		  .interrupt({tmpINTERRUPT_0__Pin_LE_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Pin_LE_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	wire [0:0] tmpOE__Pin_buttDown_net;
	wire [0:0] tmpIO_0__Pin_buttDown_net;
	wire [0:0] tmpINTERRUPT_0__Pin_buttDown_net;
	electrical [0:0] tmpSIOVREF__Pin_buttDown_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("75d1d9b2-d6ec-467f-98ab-1f20a69ea575"),
		  ...
		  .input_buffer_sel(2'b00))
		Pin_buttDown
		 (.oe(tmpOE__Pin_buttDown_net),
		  .y({1'b0}),
		  .fb({Net_74}),
		  .io({tmpIO_0__Pin_buttDown_net[0:0]}),
		  .siovref(tmpSIOVREF__Pin_buttDown_net),
		  .interrupt({tmpINTERRUPT_0__Pin_buttDown_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Pin_buttDown_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__Pin_buttUp_net;
	wire [0:0] tmpIO_0__Pin_buttUp_net;
	wire [0:0] tmpINTERRUPT_0__Pin_buttUp_net;
	electrical [0:0] tmpSIOVREF__Pin_buttUp_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("8eb4c35d-4c21-4b89-9526-8e2e8f26cae4"),
		  ...
		  .input_buffer_sel(2'b00))
		Pin_buttUp
		 (.oe(tmpOE__Pin_buttUp_net),
		  .y({1'b0}),
		  .fb({Net_68}),
		  .io({tmpIO_0__Pin_buttUp_net[0:0]}),
		  .siovref(tmpSIOVREF__Pin_buttUp_net),
		  .interrupt({tmpINTERRUPT_0__Pin_buttUp_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Pin_buttUp_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
